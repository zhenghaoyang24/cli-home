...
<template>
  <div class="flex flex-col items-center justify-center min-h-screen p-4 sm:p-6">
    <div
      class="terminal-glow rounded-xl overflow-hidden border border-[var(--border-main)]"
      style="
        width: 720px;
    ...
    >
      <div
        class="flex items-center justify-between px-4 py-2.5 border-b border-[var(--border-main)] bg-[var(--bg-surface)]"
      >
        <div class="flex items-center gap-3">
          ...
          <span class="text-xs font-mono ml-2 text-[var(--text-label)]"
            >CLI Home — zsh</span
          >
        </div>
    ...
    <p class="mt-6 text-xs font-mono tracking-widest text-[var(--border-main)]">
